export default {
  ...
  qwertzAltgr: {
    ...
    '+': ['ü¨', '´¸', null, null, '#’', 'ä^'],
    '~': ['ü¨', '´¸', null, null, '#’', 'ä^'],
    'a': [null, 'q@', 'wł', 'sſ', 'y»', null],
    'æ': [null, 'q@', 'wł', 'sſ', 'y»', null],
    's': ['aæ', 'wł', 'e€', 'dð', 'x«', 'y»'],
    'ſ': ['aæ', 'wł', 'e€', 'dð', 'x«', 'y»'],
    'd': ['sſ', 'e€', 'r¶', 'fđ', 'c¢', 'x«'],
    'ð': ['sſ', 'e€', 'r¶', 'fđ', 'c¢', 'x«'],
    ...
    '’': ['ä^', '+~', null, null, null, null],
    'y': [null, 'aæ', 'sſ', 'x«', null, null],
    '»': [null, 'aæ', 'sſ', 'x«', null, null],
