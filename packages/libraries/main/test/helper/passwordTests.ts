export default [
  ...
  },
  {
    ...
    sequence: [
      {
        ...
        l33t: true,
        subs: [
          { letter: 'c', substitution: '(' },
          {
            letter: 'o',
            substitution: '()',
          },
          { letter: 'u', substitution: '|_|' },
        ],
        subDisplay: '( -> c, () -> o, |_| -> u',
        baseGuesses: 57,
        uppercaseVariations: 1,
    ...
    crackTimesSeconds: {
      onlineThrottling100PerHour: 16452,
      onlineNoThrottling10PerSecond: 45.7,
      offlineSlowHashing1e4PerSecond: 0.0457,
      offlineFastHashing1e10PerSecond: 4.57e-8,
    },
    crackTimesDisplay: {
