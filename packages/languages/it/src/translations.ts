export default {
  warnings: {
    ...
    topHundred: 'Questa è una password usata frequentemente.',
    ...
    pwned:
      'La tua password è stata esposta da una violazione dei dati su Internet.',
  },
  suggestions: {
    ...
    dates: 'Evita le date e gli anni associati a te.',
    recentYears: 'Evita gli anni recenti.',
    associatedYears: 'Evita gli anni associati a te.',
  ...
  timeEstimation: {
    ltSecond: 'meno di un secondo',
    second: '{base} secondo',
    seconds: '{base} secondi',
    minute: '{base} minuto',
    minutes: '{base} minuti',
    hour: '{base} ora',
    hours: '{base} ore',
