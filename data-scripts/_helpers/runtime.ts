...
export default class ListHandler {
  ...
  generateIndices() {
    ...
    languages.forEach((language) => {
      ...
      const wordSequences = hasWordSequences ? '...wordSequences,' : ''
      const tempAdjacencyGraphs = hasAdjacencyGraphs
        ? `
...
const dictionary = { ${dictionaryExports}, ${wordSequences} }
${tempAdjacencyGraphs}
export {
    dictionary,
    ${translations}
